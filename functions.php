...
add_action('wp_enqueue_scripts', function () {
  ...
  wp_enqueue_script( 'main', get_stylesheet_directory_uri() . '/dist/js/main.js', ['jquery',], $theme_version, true );
  wp_enqueue_script( 'theme-customizer', get_stylesheet_directory_uri() . '/assets/js/theme-customizer.js', ['jquery', 'customize-preview'], $theme_version, true );
});
